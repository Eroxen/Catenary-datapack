...
execute if score #math.distance catenary.calc matches ..60000 run title @s actionbar {"translate":"Bound to: %s.%s, %s.%s, %s.%s","with":[{"score":{"name":"#display.x.i","objective":"catenary.calc"}},{"score":{"name":"#display.x.d","objective":"catenary.calc"}},{"score":{"name":"#display.y.i","objective":"catenary.calc"}},{"score":{"name":"#display.y.d","objective":"catenary.calc"}},{"score":{"name":"#display.z.i","objective":"catenary.calc"}},{"score":{"name":"#display.z.d","objective":"catenary.calc"}}]}
execute if score #math.distance catenary.calc matches 60000.. run title @s actionbar {"color":"red","translate":"Bound to: %s.%s, %s.%s, %s.%s","with":[{"score":{"name":"#display.x.i","objective":"catenary.calc"}},{"score":{"name":"#display.x.d","objective":"catenary.calc"}},{"score":{"name":"#display.y.i","objective":"catenary.calc"}},{"score":{"name":"#display.y.d","objective":"catenary.calc"}},{"score":{"name":"#display.z.i","objective":"catenary.calc"}},{"score":{"name":"#display.z.d","objective":"catenary.calc"}}]}
execute if score #math.distance catenary.calc matches 60000.. run return 0
