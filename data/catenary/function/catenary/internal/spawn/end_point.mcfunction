data modify entity @s {} merge value {Tags:["catenary.end_point","catenary.entity"],data:{name:"Catenary Endpoint"}}
...
ride @s mount @e[type=item_display,tag=catenary.anchor,distance=..0.1,limit=1,sort=nearest]