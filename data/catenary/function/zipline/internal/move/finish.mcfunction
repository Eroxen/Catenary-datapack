...
execute if data storage catenary:calc zipline.end_point run function catenary:zipline/internal/dismount/start

stopsound @a[distance=..16] neutral minecraft:item.elytra.flying
